...
result_arr.append({'Prompting Strategy':'finetuned (4)','Run':'NIL','random seed':'NIL','Avg. BERT score F1':round(avg_f1,2),'Avg. BERT score Precision':round(avg_precision,2),'Avg. BERT score Recall':round(avg_recall,2)})
